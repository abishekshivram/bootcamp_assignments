...
async def test_rv32i_instructions(dut):
    ...
    # R-type Instructions
    await apply_instruction(0x00B50533, 0x00B)  # ADD x10, x10, x11 (example)
    await apply_instruction(0x40B50533, 0x000)  # SUB x10, x10, x11 (example)
    await apply_instruction(0x00B51533, 0x016)  # SLL x10, x10, x11 (example)
    await apply_instruction(0x00B52533, 0x000)  # SLT x10, x10, x11 (example)
    await apply_instruction(0x00B53533, 0x000)  # SLTU x10, x10, x11 (example)
    await apply_instruction(0x00B54533, 0x000)  # XOR x10, x10, x11 (example)
    await apply_instruction(0x00B55533, 0x000)  # SRL x10, x10, x11 (example)
    await apply_instruction(0x40B55533, 0x000)  # SRA x10, x10, x11 (example)
    await apply_instruction(0x00B56533, 0x000)  # OR x10, x10, x11 (example)
    await apply_instruction(0x00B57533, 0x000)  # AND x10, x10, x11 (example)
